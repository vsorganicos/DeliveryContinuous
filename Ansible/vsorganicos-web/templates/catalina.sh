...
export JAVA_OPTS="-Xmx250000000 -Djava.awt.headless=true"
...
JAVA_OPTS="-Xms256m -Xmx256m -XX:PermSize=128m -XX:MaxPermSize=128m -verbosegc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+UseParallelGC -Duser.timezone=America/Sao_Paulo"
